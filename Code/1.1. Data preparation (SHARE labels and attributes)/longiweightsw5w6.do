...
cap recast double dw_w5
cap recast double clhw_f
cap recast double cliw_f
cap recast str6 subsample
cap recast str9 stratum1
cap recast str6 stratum2
cap recast str9 psu
cap recast str5 ssu
cap form mergeid %12s
cap form country %14.0g
cap form panel_resp %28.0g
cap form dw_w5 %10.0g
cap form clhw_f %10.0g
cap form cliw_f %10.0g
...
cap la var panel_resp `"Respondent participation in panel: 5_6"'
cap la var dw_w5 `"Design weight - wave 5"'
cap la var clhw_f `"Calibrated longitudinal household weight - panel: 5_6"'
cap la var cliw_f `"Calibrated longitudinal individual weight - panel: 5_6"'
