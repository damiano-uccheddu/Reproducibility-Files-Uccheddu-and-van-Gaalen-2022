...
cap recast double dw_w4
cap recast double clhw_e
cap recast double cliw_e
...
cap form dw_w4 %10.0g
cap form clhw_e %10.0g
cap form cliw_e %10.0g
...
cap la var panel_resp `"Respondent participation in panel: 4_5"'
cap la var dw_w4 `"Design weight - wave 4"'
cap la var clhw_e `"Calibrated longitudinal household weight - panel: 4_5"'
cap la var cliw_e `"Calibrated longitudinal individual weight - panel: 4_5"'
