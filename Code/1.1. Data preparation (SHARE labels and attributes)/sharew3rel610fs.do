...
cap recast byte sl_fs002_
cap recast int sl_fs003_
cap recast byte sl_fs004_
cap recast int sl_fs005_
cap recast byte sl_fs006_
cap recast int sl_fs007_
cap recast byte sl_fs008_
cap recast int sl_fs009_
cap recast byte sl_fs010_
cap recast int sl_fs011_
cap recast byte sl_fs013_
cap recast double sl_hh017e
...
cap form sl_fs002_ %10.0g
cap form sl_fs003_ %12.0g
cap form sl_fs004_ %10.0g
cap form sl_fs005_ %12.0g
cap form sl_fs006_ %10.0g
cap form sl_fs007_ %12.0g
cap form sl_fs008_ %10.0g
cap form sl_fs009_ %12.0g
cap form sl_fs010_ %10.0g
cap form sl_fs011_ %12.0g
cap form sl_fs013_ %20.0g
cap form sl_hh017e %10.0g
cap la val country country
cap la val language language
cap la val sl_fs002_ yesno
cap la val sl_fs003_ dkrf
cap la val sl_fs004_ yesno
cap la val sl_fs005_ dkrf
cap la val sl_fs006_ yesno
cap la val sl_fs007_ dkrf
cap la val sl_fs008_ yesno
cap la val sl_fs009_ dkrf
cap la val sl_fs010_ yesno
cap la val sl_fs011_ dkrf
cap la val sl_fs013_ proxy
cap la val sl_hh017e rfdkfin
...
cap la var sl_fs002_ `"Ever had any stocks or shares"'
cap la var sl_fs003_ `"When invested in stocks first"'
cap la var sl_fs004_ `"Ever had any mutual funds"'
cap la var sl_fs005_ `"When invested in mutual funds first"'
cap la var sl_fs006_ `"Ever had retirement account"'
cap la var sl_fs007_ `"When subscribed to retirement account first"'
cap la var sl_fs008_ `"Ever taken out a life insurance policy"'
cap la var sl_fs009_ `"When taken out a life insurance policy first"'
cap la var sl_fs010_ `"Ever owned business"'
cap la var sl_fs011_ `"When first owned business"'
cap la var sl_fs013_ `"Proxy check"'
cap la var sl_hh017e `"Total household net income in average month"'
