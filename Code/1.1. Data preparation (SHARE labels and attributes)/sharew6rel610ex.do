...
cap la de praying -2 `"Refusal"', modify
cap la de praying -1 `"Don't know"', modify
cap la de praying 1 `"More than once a day"', modify
cap la de praying 2 `"Once daily"', modify
cap la de praying 3 `"A couple of times a week"', modify
cap la de praying 4 `"Once a week"', modify
cap la de praying 5 `"Less than once a week"', modify
cap la de praying 6 `"Never"', modify
cap la de partnercurrentjob -2 `"Refusal"', modify
cap la de partnercurrentjob -1 `"Don't know"', modify
cap la de partnercurrentjob 1 `"Retired"', modify
cap la de partnercurrentjob 2 `"Employed or self-employed (including workingfor family business)"', modify
cap la de partnercurrentjob 3 `"Unemployed and looking for work"', modify
cap la de partnercurrentjob 4 `"Permanently sick or disabled"', modify
cap la de partnercurrentjob 5 `"Homemaker"', modify
cap la de partnercurrentjob 6 `"Other"', modify
cap la de partnercurrentjob 97 `"Other"', modify
...
cap la de partneremployee -2 `"Refusal"', modify
cap la de partneremployee -1 `"Don't know"', modify
cap la de partneremployee 1 `"Employee (private sector)"', modify
cap la de partneremployee 2 `"Public sector employee/civil servant"', modify
cap la de partneremployee 3 `"Self-employed"', modify
cap la de riskaversion -2 `"Refusal"', modify
cap la de riskaversion -1 `"Don't know"', modify
cap la de riskaversion 1 `"Take substantial financial risks expecting to earnsubstantial returns"', modify
cap la de riskaversion 2 `"Take above average financial risks expecting to earn above average returns"', modify
cap la de riskaversion 3 `"Take average financial risks expecting to earn average returns"', modify
cap la de riskaversion 4 `"Not willing to take any financial risks"', modify
cap la de ex111_ -2 `"Refusal"', modify
cap la de ex111_ -1 `"Don't know"', modify
cap la de ex111_ 1 `"Next few months"', modify
cap la de ex111_ 2 `"Next Year"', modify
cap la de ex111_ 3 `"Next few years"', modify
cap la de ex111_ 4 `"Next 5-10 years"', modify
cap la de ex111_ 5 `"Longer than 10 years"', modify
cap la de rfdkfin -9999992 `"Refusal"', modify
cap la de rfdkfin -9999991 `"Don't know"', modify
cap la de ex600_ -2 `"Refusal"', modify
cap la de ex600_ -1 `"Don't know"', modify
cap la de ex600_ 1 `"Yes, Partner is available"', modify
cap la de ex600_ 2 `"No, partner is unavailable"', modify
cap la de ex600_ 3 `"No, partner is unwilling"', modify
cap la de ex601_ -2 `"Refusal"', modify
cap la de ex601_ -1 `"Don't know"', modify
cap la de ex601_ 1 `"Continue"', modify
cap la de ex601_ 5 `"Proxy-interview"', modify
...
cap recast byte ex025_
cap recast byte ex026_
cap recast byte ex028_
cap recast byte ex029_
cap recast byte ex103_
cap recast byte ex104_
cap recast byte ex105_
cap recast byte ex110_
cap recast byte ex111_
cap recast long ex121_
cap recast byte ex600_
cap recast byte ex601_
cap recast byte ex602_
cap recast int ex603isco
...
cap form ex001_ %10.0g
cap form ex007_ %10.0g
cap form ex008_ %10.0g
cap form ex009_ %10.0g
cap form ex009age %8.0g
cap form ex025_ %10.0g
cap form ex026_ %10.0g
cap form ex028_ %10.0g
cap form ex029_ %31.0g
cap form ex103_ %65.0g
cap form ex104_ %10.0g
cap form ex105_ %36.0g
cap form ex110_ %118.0g
cap form ex111_ %24.0g
cap form ex121_ %10.0g
cap form ex600_ %91.0g
cap form ex601_ %24.0g
cap form ex602_ %10.0g
cap form ex603isco %10.0g
...
cap la val ex025_ dkrf
cap la val ex026_ dkrf
cap la val ex028_ dkrf
cap la val ex029_ praying
cap la val ex103_ partnercurrentjob
cap la val ex104_ yesno
cap la val ex105_ partneremployee
cap la val ex110_ riskaversion
cap la val ex111_ ex111_
cap la val ex121_ rfdkfin
cap la val ex600_ ex600_
cap la val ex601_ ex601_
cap la val ex602_ dkrf
cap la val ex603isco dkrf
...
cap la var ex025_ `"Chance to work after age of 63"'
cap la var ex026_ `"Trust in other people"'
cap la var ex028_ `"Left or right in politics"'
cap la var ex029_ `"Frequency of praying"'
cap la var ex103_ `"Partner current job situation"'
cap la var ex104_ `"Partner ever done paid work"'
cap la var ex105_ `"Partner employee or a self-employed"'
cap la var ex110_ `"Risk aversion"'
cap la var ex111_ `"Planning horizon of saving and spending"'
cap la var ex121_ `"Outside temperature in degree celsius"'
cap la var ex600_ `"Partner available/willing to be (proxy) interviewed"'
cap la var ex601_ `"Start of non proxy section"'
cap la var ex602_ `"Amount of years spouse/partner been in school"'
cap la var ex603isco `"ISCO code: Most recent job of spouse/partner"'
