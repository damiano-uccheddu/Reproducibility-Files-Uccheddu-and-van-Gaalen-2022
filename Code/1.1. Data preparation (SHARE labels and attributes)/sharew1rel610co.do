...
cap la de situationimprovement -2 `"Refusal"', modify
cap la de situationimprovement -1 `"Don't know"', modify
cap la de situationimprovement 1 `"Greatly improved"', modify
cap la de situationimprovement 2 `"Somewhat improved"', modify
cap la de situationimprovement 3 `"Remained the same"', modify
cap la de situationimprovement 4 `"Somewhat deteriorated"', modify
cap la de situationimprovement 5 `"Greatly deteriorated"', modify
...
cap recast double co004e
cap recast double co005e
cap recast byte co007_
cap recast byte co008_
...
cap form co002e %222.0g
cap form co003e %222.0g
cap form co004e %222.0g
cap form co005e %222.0g
cap form co007_ %28.0f
cap form co008_ %21.0f
cap form co009_ %20.0f
cap la val country country
cap la val language language
cap la val co002e rfdkfin
cap la val co003e rfdkfin
cap la val co004e rfdkfin
cap la val co005e rfdkfin
cap la val co007_ household
cap la val co008_ situationimprovement
...
cap la var co004e `"Amount spent on telephones in last month"'
cap la var co005e `"Amount spent on all goods and services in last month"'
cap la var co007_ `"Is household able to make ends meet"'
cap la var co008_ `"Situation improvement thinking back one year"'
