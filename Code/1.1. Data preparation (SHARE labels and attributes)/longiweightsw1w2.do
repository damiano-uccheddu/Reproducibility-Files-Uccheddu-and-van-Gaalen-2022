...
cap recast double clhw_b
cap recast double cliw_b
...
cap form clhw_b %10.0g
cap form cliw_b %10.0g
...
cap la var panel_resp `"Respondent participation in panel: 1_2"'
cap la var dw_w1 `"Design weight - wave 1"'
cap la var clhw_b `"Calibrated longitudinal household weight - panel: 1_2"'
cap la var cliw_b `"Calibrated longitudinal individual weight - panel: 1_2"'
