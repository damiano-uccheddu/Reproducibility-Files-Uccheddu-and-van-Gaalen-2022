...
cap recast float co002v1
cap recast float co002v2
cap recast float co002v3
cap recast double co003e
cap recast byte co003ub
cap recast float co003v1
cap recast float co003v2
cap recast float co003v3
...
cap recast float co011v3
cap recast double co020e
cap recast byte co201_
cap recast byte co202_
cap recast byte co206_
cap recast byte co207_
cap recast byte co208_
cap recast byte co209_
cap recast byte co211_
cap recast byte co213_
...
cap form co002e %10.0g
cap form co002ub %32.0g
cap form co002v1 %9.0g
cap form co002v2 %9.0g
cap form co002v3 %9.0g
cap form co003e %10.0g
cap form co003ub %32.0g
cap form co003v1 %9.0g
cap form co003v2 %9.0g
cap form co003v3 %9.0g
cap form co007_ %31.0g
cap form co009_ %47.0g
cap form co010_ %10.0g
cap form co011e %10.0g
cap form co011ub %32.0g
cap form co011v1 %9.0g
cap form co011v2 %9.0g
cap form co011v3 %9.0g
cap form co020e %12.0g
cap form co201_ %10.0g
cap form co202_ %10.0g
cap form co206_ %10.0g
cap form co207_ %10.0g
cap form co208_ %10.0g
cap form co209_ %10.0g
cap form co211_ %10.0g
cap form co213_ %10.0g
...
cap la val co020e rfdkfin
cap la val co201_ yesno
cap la val co202_ yesno
cap la val co206_ yesno
cap la val co207_ yesno
cap la val co208_ yesno
cap la val co209_ yesno
cap la val co211_ yesno
cap la val co213_ yesno
...
cap la var co020e `"Minimum amount needed per month"'
cap la var co201_ `"Afford to regularly buy necessary groceries"'
cap la var co202_ `"Afford to go on holiday at least once a year (a week long)"'
cap la var co206_ `"Afford to pay an unexpected expense without borrowing money"'
cap la var co207_ `"To help keeping living costs down: continued wearing clothing that was worn out"'
cap la var co208_ `"To help keeping living costs down: continued wearing shoes that were worn out"'
cap la var co209_ `"To help keeping living costs down: put up with feeling cold"'
cap la var co211_ `"To help keeping living costs down: postponed visits to the dentist"'
cap la var co213_ `"To help keeping living costs down: gone without or not replaced glasses"'
