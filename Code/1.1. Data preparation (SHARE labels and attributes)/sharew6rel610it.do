...
cap la de pc_skills -2 `"Refusal"', modify
cap la de pc_skills -1 `"Don't know"', modify
cap la de pc_skills 1 `"Excellent"', modify
cap la de pc_skills 2 `"Very good"', modify
cap la de pc_skills 3 `"Good"', modify
cap la de pc_skills 4 `"Fair"', modify
cap la de pc_skills 5 `"Poor"', modify
cap la de pc_skills 6 `"I never used a computer"', modify
...
cap recast byte it001_
cap recast byte it002_
cap recast byte it003_
cap recast byte it004_
...
cap form it001_ %10.0g
cap form it002_ %10.0g
cap form it003_ %51.0g
cap form it004_ %10.0g
cap la val country country
cap la val language language
cap la val it001_ yesno
cap la val it002_ yesno
cap la val it003_ pc_skills
cap la val it004_ yesno
...
cap la var it001_ `"Current job requires using a computer"'
cap la var it002_ `"Last job before retiring required using a computer"'
cap la var it003_ `"Computer skills"'
cap la var it004_ `"Use of internet in past 7 days"'
