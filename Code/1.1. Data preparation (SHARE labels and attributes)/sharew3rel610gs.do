...
cap la de willingtomeasure -2 `"Refusal"', modify
cap la de willingtomeasure -1 `"Don't know"', modify
cap la de willingtomeasure 1 `"R agrees to take measurement"', modify
cap la de willingtomeasure 2 `"R refuses to take measurement"', modify
cap la de willingtomeasure 3 `"R is unable to take measurement"', modify
cap la de handuse -2 `"Refusal"', modify
cap la de handuse -1 `"Don't know"', modify
cap la de handuse 1 `"Respondent has the use of both hands"', modify
cap la de handuse 2 `"Respondent is unable to use right hand"', modify
cap la de handuse 3 `"Respondent is unable to use left hand"', modify
cap la de handuse 4 `"Respondent is unable to use either hand"', modify
cap la de gs004 -2 `"Refusal"', modify
cap la de gs004 -1 `"Don't know"', modify
cap la de gs004 1 `"Right hand"', modify
cap la de gs004 2 `"Left hand"', modify
...
cap la de effortgiven -2 `"Refusal"', modify
cap la de effortgiven -1 `"Don't know"', modify
cap la de effortgiven 1 `"R gave full effort"', modify
cap la de effortgiven 2 `"R was prevented from giving full effort by illness,pain, or other symptoms or discomforts"', modify
cap la de effortgiven 3 `"R did not appear to give full effort, but no obvious reason for this"', modify
...
cap recast byte sl_gs001_
cap recast byte sl_gs002_
cap recast byte sl_gs004_
cap recast byte sl_gs006_
cap recast byte sl_gs007_
cap recast byte sl_gs008_
cap recast byte sl_gs009_
cap recast byte sl_gs010d1
cap recast byte sl_gs010d2
cap recast byte sl_gs010d3
cap recast byte sl_gs010d4
cap recast byte sl_gs010d5
cap recast byte sl_gs010d6
cap recast byte sl_gs010dot
cap recast byte sl_gs012_
cap recast byte sl_gs013_
cap recast byte sl_gs014_
...
cap form sl_gs001_ %31.0g
cap form sl_gs002_ %39.0g
cap form sl_gs004_ %10.0g
cap form sl_gs006_ %10.0g
cap form sl_gs007_ %10.0g
cap form sl_gs008_ %10.0g
cap form sl_gs009_ %10.0g
cap form sl_gs010d1 %12.0g
cap form sl_gs010d2 %12.0g
cap form sl_gs010d3 %12.0g
cap form sl_gs010d4 %12.0g
cap form sl_gs010d5 %12.0g
cap form sl_gs010d6 %12.0g
cap form sl_gs010dot %12.0g
cap form sl_gs012_ %90.0g
cap form sl_gs013_ %10.0g
cap form sl_gs014_ %10.0g
cap la val country country
cap la val language language
cap la val sl_gs001_ willingtomeasure
cap la val sl_gs002_ handuse
cap la val sl_gs004_ gs004
cap la val sl_gs006_ dkrf
cap la val sl_gs007_ dkrf
cap la val sl_gs008_ dkrf
cap la val sl_gs009_ dkrf
cap la val sl_gs010d1 dummi
cap la val sl_gs010d2 dummi
cap la val sl_gs010d3 dummi
cap la val sl_gs010d4 dummi
cap la val sl_gs010d5 dummi
cap la val sl_gs010d6 dummi
cap la val sl_gs010dot dummi
cap la val sl_gs012_ effortgiven
cap la val sl_gs013_ position
cap la val sl_gs014_ yesno
...
cap la var sl_gs001_ `"Willing to have handgrip measured"'
cap la var sl_gs002_ `"Record respondent status"'
cap la var sl_gs004_ `"Dominant hand"'
cap la var sl_gs006_ `"1st measurement: left hand"'
cap la var sl_gs007_ `"2nd measurement: left hand"'
cap la var sl_gs008_ `"1st measurement: right hand"'
cap la var sl_gs009_ `"2nd measurement: right hand"'
cap la var sl_gs010d1 `"Why not completed gs test: r felt it would not be safe"'
cap la var sl_gs010d2 `"Why not completed gs test: iwer felt it would not be safe"'
cap la var sl_gs010d3 `"Why not completed gs test: r refused, no reason given"'
cap la var sl_gs010d4 `"Why not completed gs test: r tried but was unable to complete test"'
cap la var sl_gs010d5 `"Why not completed gs test: r did not understand the instructions"'
cap la var sl_gs010d6 `"Why not completed gs test: r had surgery, injury, swelling, etc."'
cap la var sl_gs010dot `"Why not completed gs test: others"'
cap la var sl_gs012_ `"How much effort gave r"'
cap la var sl_gs013_ `"The position of r for this test"'
cap la var sl_gs014_ `"R rested his/her arms on a support"'
