...
cap la de mn028_ -2 `"Refusal"', modify
cap la de mn028_ -1 `"Don't know"', modify
cap la de mn028_ 0 `"Not eligible"', modify
cap la de mn028_ 1 `"Eligible"', modify
cap la de mn028_ 2 `"Eligible (routing version 2)"', modify
cap la de mn028_ 3 `"Eligible (routing version 3)"', modify
cap la de mn028_ 4 `"Eligible (routing version 4)"', modify
...
cap recast byte mn028_
cap recast byte mn029_
cap recast byte mn030_
cap recast byte mn032_
...
cap form mn026_ %10.0g
cap form mn028_ %28.0g
cap form mn029_ %10.0g
cap form mn030_ %10.0g
cap form mn032_ %10.0g
...
cap la val mn028_ mn028_
cap la val mn029_ yesnomn
cap la val mn030_ yesnomn
cap la val mn032_ yesnomn
...
cap la var mn028_ `"Eligible for dried blood spots collection (bs & gv_dbs) "'
cap la var mn029_ `"Eligible for linkage"'
cap la var mn030_ `"Eligible for social networks module (sn)"'
cap la var mn032_ `"Eligible for social exclusion items"'
