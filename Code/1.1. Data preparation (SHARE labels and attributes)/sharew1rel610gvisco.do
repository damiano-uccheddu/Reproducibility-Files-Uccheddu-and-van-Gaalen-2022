...
cap recast str4 isco_1job
cap recast str100 text_1job
cap recast str4 nace_1job
cap recast str163 ind_1job
cap recast str4 isco_2job
cap recast str80 text_2job
cap recast str4 nace_2job
cap recast str163 ind_2job
cap recast str4 isco_ljob
cap recast str100 text_ljob
cap recast str4 nace_ljob
cap recast str163 ind_ljob
cap recast str4 isco_exp
cap recast str80 text_exp
cap recast str4 isco_mo
cap recast str80 text_mo
cap recast str4 isco_fa
cap recast str100 text_fa
...
cap form isco_1job %4s
cap form text_1job %100s
cap form nace_1job %9s
cap form ind_1job %163s
cap form isco_2job %4s
cap form text_2job %80s
cap form nace_2job %9s
cap form ind_2job %163s
cap form isco_ljob %4s
cap form text_ljob %100s
cap form nace_ljob %9s
cap form ind_ljob %163s
cap form isco_exp %4s
cap form text_exp %80s
cap form isco_mo %4s
cap form text_mo %80s
cap form isco_fa %4s
cap form text_fa %100s
...
cap la var isco_1job `"Isco-88 respondent's first job (ep016_1)"'
cap la var text_1job `"Label for isco_1job (respondent's first job)"'
cap la var nace_1job `"Nace industry of respondent's first job (ep018_1 / ep023_1)"'
cap la var ind_1job `"Label for nace_1job (industry of respondent's first job)"'
cap la var isco_2job `"Isco-88 respondent's second job (ep016_2)"'
cap la var text_2job `"Label for isco_2job (respondent's second job)"'
cap la var nace_2job `"Nace industry of respondent's second job (ep018_2 / ep023_2)"'
cap la var ind_2job `"Label for nace_2job (industry of respondent's second job)"'
cap la var isco_ljob `"Isco-88 respondent's last job (ep052)"'
cap la var text_ljob `"Label for isco_ljob (respondent's last job)"'
cap la var nace_ljob `"Nace industry of respondent's last job (ep054 / ep060)"'
cap la var ind_ljob `"Label for nace_ljob (industry of respondent's last job)"'
cap la var isco_exp `"Isco-88 former partner's job (dn025)"'
cap la var text_exp `"Label for isco_exp (former partner's job)"'
cap la var isco_mo `"Isco-88 mother's job (dn029_1)"'
cap la var text_mo `"Label for isco_mo (mother's job)"'
cap la var isco_fa `"Isco-88 father's job (dn029_2)"'
cap la var text_fa `"Label for isco_fa (father's job)"'
