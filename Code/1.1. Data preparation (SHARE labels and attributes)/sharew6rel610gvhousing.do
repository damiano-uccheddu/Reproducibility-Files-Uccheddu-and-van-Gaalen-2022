...
cap la de typebldgi_w6 -2 `"Refusal"', modify
cap la de typebldgi_w6 -1 `"Don't know"', modify
cap la de typebldgi_w6 1 `"A farm house"', modify
cap la de typebldgi_w6 2 `"A free standing one or two family house"', modify
cap la de typebldgi_w6 3 `"A one or two family house as row or double house"', modify
cap la de typebldgi_w6 4 `"A building with 3 to 8 flats"', modify
cap la de typebldgi_w6 5 `"A building with 9 or more flats but no more than 8floors"', modify
cap la de typebldgi_w6 6 `"A high-rise with 9 or more floors"', modify
cap la de typebldgi_w6 7 `"A housing complex with services for elderly"', modify
cap la de typebldgi_w6 8 `"A nursing home"', modify
...
cap recast byte typebldgi6
cap recast byte nstepsi
cap recast str30 nuts1_2015
cap recast str66 nuts2_2015
cap recast str40 nuts3_2015
...
cap form typebldgi6 %57.0g
cap form nstepsi %12.0g
cap form nuts1_2015 %30s
cap form nuts2_2015 %66s
cap form nuts3_2015 %40s
cap la val country country
cap la val language language
cap la val areabldgi areabldgi
cap la val typebldgi6 typebldgi_w6
...
cap la var typebldgi6 `"Type of building in w6"'
cap la var nstepsi `"Number of steps to entrance"'
cap la var nuts1_2015 `"NUTS 2015 level 1: nomenclature of territorial units for statistics"'
cap la var nuts2_2015 `"NUTS 2015 level 2: nomenclature of territorial units for statistics"'
cap la var nuts3_2015 `"NUTS 2015 level 3: nomenclature of territorial units for statistics"'
