...
cap la de iscedy -7 `"Not yet coded (temporary)"', modify
cap la de iscedy -2 `"Refusal"', modify
cap la de iscedy -1 `"Don't know"', modify
cap la de iscedy 0 `"None"', modify
cap la de iscedy 95 `"Still in school"', modify
cap la de iscedy 97 `"Other"', modify
...
cap recast byte isced1997_iv
cap recast byte isced1997_r
cap recast byte isced1997_sp
cap recast float isced1997y_c1
cap recast float isced1997y_c2
cap recast float isced1997y_c3
cap recast float isced1997y_c4
cap recast float isced1997y_iv
cap recast float isced1997y_r
cap recast float isced1997y_sp
...
cap form isced1997_iv %15.0g
cap form isced1997_r %15.0g
cap form isced1997_sp %15.0g
cap form isced1997y_c1 %25.0g
cap form isced1997y_c2 %25.0g
cap form isced1997y_c3 %25.0g
cap form isced1997y_c4 %25.0g
cap form isced1997y_iv %25.0g
cap form isced1997y_r %25.0g
cap form isced1997y_sp %25.0g
...
cap la val isced1997_iv isced
cap la val isced1997_r isced
cap la val isced1997_sp isced
cap la val isced1997y_c1 iscedy
cap la val isced1997y_c2 iscedy
cap la val isced1997y_c3 iscedy
cap la val isced1997y_c4 iscedy
cap la val isced1997y_iv iscedy
cap la val isced1997y_r iscedy
cap la val isced1997y_sp iscedy
...
cap la var isced1997_iv `"Interviewer: ISCED-97 coding of education"'
...
cap la var isced1997y_c1 `"Respondent's sel. child 1: years of education derived from ISCED-97"'
cap la var isced1997y_c2 `"Respondent's sel. child 2: years of education derived from ISCED-97"'
cap la var isced1997y_c3 `"Respondent's sel. child 3: years of education derived from ISCED-97"'
cap la var isced1997y_c4 `"Respondent's sel. child 4: years of education derived from ISCED-97"'
cap la var isced1997y_iv `"Interviewer: years of education derived from ISCED-97"'
cap la var isced1997y_r `"Respondent: years of education derived from ISCED-97"'
cap la var isced1997y_sp `"Spouse/ex-spouse of respondent: years of education derived from ISCED-97"'
