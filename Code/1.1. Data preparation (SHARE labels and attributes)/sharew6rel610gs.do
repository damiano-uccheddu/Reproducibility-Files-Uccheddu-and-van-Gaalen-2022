...
cap la de willingtomeasure 5 `"Proxy-interview"', modify
...
cap la de gs004 3 `"Ambidexterity"', modify
...
cap recast byte gs001_
cap recast byte gs002_
cap recast byte gs004_
cap recast byte gs006_
cap recast byte gs007_
cap recast byte gs008_
cap recast byte gs009_
cap recast byte gs010d1
cap recast byte gs010d2
cap recast byte gs010d3
cap recast byte gs010d4
cap recast byte gs010d5
cap recast byte gs010d6
cap recast byte gs010dot
cap recast byte gs012_
cap recast byte gs013_
cap recast byte gs014_
...
cap form gs001_ %58.0g
cap form gs002_ %51.0g
cap form gs004_ %13.0g
cap form gs006_ %10.0g
cap form gs007_ %10.0g
cap form gs008_ %10.0g
cap form gs009_ %10.0g
cap form gs010d1 %12.0g
cap form gs010d2 %12.0g
cap form gs010d3 %12.0g
cap form gs010d4 %12.0g
cap form gs010d5 %12.0g
cap form gs010d6 %12.0g
cap form gs010dot %12.0g
cap form gs012_ %110.0g
cap form gs013_ %10.0g
cap form gs014_ %10.0g
cap la val country country
cap la val language language
cap la val gs001_ willingtomeasure
cap la val gs002_ handuse
cap la val gs004_ gs004
cap la val gs006_ dkrf
cap la val gs007_ dkrf
cap la val gs008_ dkrf
cap la val gs009_ dkrf
cap la val gs010d1 dummi
cap la val gs010d2 dummi
cap la val gs010d3 dummi
cap la val gs010d4 dummi
cap la val gs010d5 dummi
cap la val gs010d6 dummi
cap la val gs010dot dummi
cap la val gs012_ effortgiven
cap la val gs013_ position
cap la val gs014_ yesno
...
cap la var gs001_ `"Willing to have handgrip measured"'
cap la var gs002_ `"Record respondent status"'
cap la var gs004_ `"Dominant hand"'
cap la var gs006_ `"1st measurement: left hand"'
cap la var gs007_ `"2nd measurement: left hand"'
cap la var gs008_ `"1st measurement: right hand"'
cap la var gs009_ `"2nd measurement: right hand"'
cap la var gs010d1 `"Why not completed gs test: r felt it would not be safe"'
cap la var gs010d2 `"Why not completed gs test: iwer felt it would not be safe"'
cap la var gs010d3 `"Why not completed gs test: r refused, no reason given"'
cap la var gs010d4 `"Why not completed gs test: r tried but was unable to complete test"'
cap la var gs010d5 `"Why not completed gs test: r did not understand the instructions"'
cap la var gs010d6 `"Why not completed gs test: r had surgery, injury, swelling, etc."'
cap la var gs010dot `"Why not completed gs test: others"'
cap la var gs012_ `"How much effort gave r"'
cap la var gs013_ `"The position of r for this test"'
cap la var gs014_ `"R rested his/her arms on a support"'
