...
cap recast double clhw_c
cap recast double cliw_c
...
cap form clhw_c %10.0g
cap form cliw_c %10.0g
...
cap la var panel_resp `"Respondent participation in panel: 2_3"'
cap la var dw_w2 `"Design weight - wave 2"'
cap la var clhw_c `"Calibrated longitudinal household weight - panel: 2_3"'
cap la var cliw_c `"Calibrated longitudinal individual weight - panel: 2_3"'
