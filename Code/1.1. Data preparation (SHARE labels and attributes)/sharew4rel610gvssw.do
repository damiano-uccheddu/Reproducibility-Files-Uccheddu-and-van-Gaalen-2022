...
cap recast float SSW_gw
cap recast float SSW_nw
...
cap form SSW_gw %9.0g
cap form SSW_nw %9.0g
...
cap la var SSW_gw `"Social security wealth (based on approx. gross wage)"'
cap la var SSW_nw `"Social security wealth (based on net wage)"'
