...
cap recast double dw_w3
cap recast double clhw_d
cap recast double cliw_d
...
cap form dw_w3 %10.0g
cap form clhw_d %10.0g
cap form cliw_d %10.0g
...
cap la var panel_resp `"Respondent participation in panel: 3_4"'
cap la var dw_w3 `"Design weight - wave 3"'
cap la var clhw_d `"Calibrated longitudinal household weight - panel: 3_4"'
cap la var cliw_d `"Calibrated longitudinal individual weight - panel: 3_4"'
