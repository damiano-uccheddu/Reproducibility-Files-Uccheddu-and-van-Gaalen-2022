...
cap la de PT -9 `"Not applicable"', modify
cap la de PT -2 `"Refusal"', modify
cap la de PT -1 `"Don't know"', modify
cap la de PT 1 `"General sample"', modify
cap la de PT 2 `"Lisbon sample"', modify
...
cap la var age2011 `"Age in 2011"'
...
cap la var agep2011 `"Age of partner in 2011"'
...
cap la var interview `"Interview done in wave 4"'
cap la var int_year `"Interview year"'
cap la var int_month `"Interview month"'
cap la var PTsample `"Portugal only: sample indication"'
