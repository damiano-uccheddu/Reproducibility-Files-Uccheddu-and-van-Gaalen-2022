...
cap la de br_time -2 `"Refusal"', modify
cap la de br_time -1 `"Don't know"', modify
cap la de br_time 1 `"Every day"', modify
cap la de br_time 2 `"3-6 times a week"', modify
cap la de br_time 3 `"Twice a week"', modify
cap la de br_time 4 `"Once a week"', modify
cap la de br_time 5 `"Less than once a week"', modify
cap la de food_afford -2 `"Refusal"', modify
cap la de food_afford -1 `"Don't know"', modify
cap la de food_afford 1 `"Cannot afford to eat it more often"', modify
cap la de food_afford 2 `"For other reasons"', modify
cap la de br623_ -2 `"Refusal"', modify
cap la de br623_ -1 `"Don't know"', modify
cap la de br623_ 1 `"Daily or almost daily"', modify
cap la de br623_ 2 `"Five or six days a week"', modify
cap la de br623_ 3 `"Three or four days a week"', modify
cap la de br623_ 4 `"Once or twice a week"', modify
cap la de br623_ 5 `"Once or twice a month"', modify
cap la de br623_ 6 `"Less than once a month"', modify
cap la de br623_ 7 `"Not at all in the last 3 months"', modify
...
cap recast float br003_
cap recast byte br005d1
cap recast byte br005d2
cap recast byte br005d3
cap recast byte br005d4
cap recast byte br006_
cap recast byte br015_
cap recast byte br016_
cap recast byte br017_
cap recast byte br026_
cap recast byte br027_
cap recast byte br028_
cap recast byte br029_
cap recast byte br033_
cap recast byte br039_
cap recast byte br040_
cap recast byte br623_
...
cap form br005d4 %12.0g
cap form br006_ %10.0g
cap form br015_ %26.0g
cap form br016_ %26.0g
cap form br017_ %44.0g
cap form br026_ %31.0g
cap form br027_ %31.0g
cap form br028_ %31.0g
cap form br029_ %31.0g
cap form br033_ %64.0g
cap form br039_ %10.0g
cap form br040_ %10.0g
cap form br623_ %38.0g
...
cap la val br005d4 dummi
cap la val br006_ dkrf
cap la val br015_ br_more
cap la val br016_ br_more
cap la val br017_ proxy
cap la val br026_ br_time
cap la val br027_ br_time
cap la val br028_ br_time
cap la val br029_ br_time
cap la val br033_ food_afford
cap la val br039_ yesno
cap la val br040_ dkrf
cap la val br623_ br623_
...
cap la var br005d4 `"Do or did smoke: e-cigarettes with nicotine solution"'
...
cap la var br026_ `"How often serving of dairy products"'
cap la var br027_ `"How often serving of legumes or eggs"'
cap la var br028_ `"How often serving of meat, fish or chicken"'
cap la var br029_ `"How often serving of fruits or vegetables"'
cap la var br033_ `"Not eating meat, fish or chicken more often because ..."'
cap la var br039_ `"At least one alcoholic beverage the last 7 days"'
cap la var br040_ `"Units of alcoholic beverage the last seven days"'
cap la var br623_ `"How often 6 or more drinks the last 3 months"'
