...
cap recast float hh011e
cap recast byte hh011ub
cap recast float hh011v1
cap recast float hh011v2
cap recast float hh011v3
cap recast byte hh014_
cap recast float hh017e
cap recast byte hh017ub
cap recast float hh017v1
cap recast float hh017v2
cap recast double hh017v3
cap recast byte hh022_
cap recast byte hh023_
cap recast byte hh024_
cap recast byte hh025_
...
cap form hh014_ %44.0g
cap form hh017e %10.0g
cap form hh017ub %32.0g
cap form hh017v1 %8.0g
cap form hh017v2 %8.0g
cap form hh017v3 %8.0g
cap form hh022_ %26.0g
cap form hh023_ %26.0g
cap form hh024_ %26.0g
cap form hh025_ %26.0g
...
cap la val hh017ub eurocon_entry
cap la val hh022_ agree
cap la val hh023_ agree
cap la val hh024_ agree
cap la val hh025_ agree
...
cap la var hh017ub `"Total income received by all hh-members an average month last year ub"'
cap la var hh017v1 `"Bracket value 1"'
cap la var hh017v2 `"Bracket value 2"'
cap la var hh017v3 `"Bracket value 3"'
cap la var hh022_ `"Feeling part of this area"'
cap la var hh023_ `"Vandalism/Crime is a big problem in this area"'
cap la var hh024_ `"Area is kept very clean"'
cap la var hh025_ `"If I were in trouble, there are people in this area who would help me"'
