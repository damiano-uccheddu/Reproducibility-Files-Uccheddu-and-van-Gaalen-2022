...
cap la de dbs_values 0 `"No values available"', modify
cap la de dbs_values 1 `"Values (will be) available"', modify
...
cap recast byte dbs_values_exp
cap recast byte spots_nr
cap recast byte spots_co
...
cap form dbs_values_exp %26.0g
cap form spots_nr %10.0g
cap form spots_co %10.0g
cap la val country country
cap la val language language
cap la val dbs_values_exp dbs_values
...
cap la var dbs_values_exp `"Expected availability of laboratory results"'
cap la var spots_nr `"Number of blood spots collected"'
cap la var spots_co `"Number of blood spots filling pre-printed circle"'
