...
cap la de deceased 1 `"Dead"', modify
...
cap la de mstat -9 `"Not applicable"', modify
cap la de mstat -2 `"Refusal"', modify
cap la de mstat -1 `"Don't know"', modify
cap la de mstat 1 `"Living with a spouse"', modify
cap la de mstat 2 `"Living with a partner"', modify
cap la de mstat 3 `"Living as a single"', modify
cap la de mstat 97 `"Other"', modify
cap la de relationw3 -2 `"Refusal"', modify
cap la de relationw3 -1 `"Don't know"', modify
cap la de relationw3 1 `"Spouse"', modify
cap la de relationw3 2 `"Partner"', modify
cap la de relationw3 3 `"Child"', modify
cap la de relationw3 4 `"Child-in-law"', modify
cap la de relationw3 5 `"Parent"', modify
cap la de relationw3 6 `"Parent-in-law"', modify
cap la de relationw3 7 `"Sibling"', modify
cap la de relationw3 8 `"Grand-child"', modify
cap la de relationw3 9 `"Other relative"', modify
cap la de relationw3 10 `"Other non-relative"', modify
cap la de relationw3 11 `"Ex-spouse/ex-partner"', modify
cap la de relationw3 12 `"Deceased spouse"', modify
cap la de relationw3 13 `"Proxy"', modify
...
cap la val age2009 dkrfna
cap la val age_int dkrfna
cap la val mobirthp month3
cap la val yrbirthp dkrfna
cap la val agep2009 dkrfna
cap la val partnerinhh mstat
cap la val relrpers relationw3
...
cap la var age2009 `"Age in 2009"'
...
cap la var agep2009 `"Age of partner in 2009"'
...
cap la var interview `"Interview done in wave 3"'
