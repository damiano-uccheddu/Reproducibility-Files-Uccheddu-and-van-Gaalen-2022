...
cap la de depsev 0 `"No"', modify
cap la de depsev 1 `"Yes"', modify
...
cap recast float depmat
cap recast float depsoc
cap recast byte depsev
...
cap form depmat %9.0g
cap form depsoc %9.0g
cap form depsev %9.0g
cap la val country country
cap la val language language
cap la val depsev depsev
...
cap la var depmat `"Deprivation index - hedonic weights 2 - pvalue"'
cap la var depsoc `"Social deprivation index - hedonic weights"'
cap la var depsev `"At risk of severe deprivation and social deprivation (75pc)"'
