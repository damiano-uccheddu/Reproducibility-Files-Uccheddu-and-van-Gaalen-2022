...
cap la de ws001_ -2 `"Refusal"', modify
cap la de ws001_ -1 `"Don't know"', modify
cap la de ws001_ 1 `"Observed walking without help of another person"', modify
cap la de ws001_ 2 `"Observed walking with help of another person"', modify
cap la de ws001_ 3 `"Not observed - in wheelchair"', modify
cap la de ws001_ 4 `"Not observed - bed bound"', modify
cap la de ws001_ 5 `"Not observed - uncertain if respondent"', modify
cap la de ws002_ -2 `"Refusal"', modify
cap la de ws002_ -1 `"Don't know"', modify
cap la de ws002_ 1 `"Yes"', modify
cap la de ws002_ 2 `"Yes, but aid unavailable"', modify
cap la de ws002_ 3 `"No"', modify
cap la de ws003_ -2 `"Refusal"', modify
cap la de ws003_ -1 `"Don't know"', modify
cap la de ws003_ 1 `"No apparent restriction"', modify
cap la de ws003_ 2 `"Yes, recent surgery"', modify
cap la de ws003_ 3 `"Yes, injury"', modify
cap la de ws003_ 4 `"Yes, other health condition"', modify
...
cap la de ws007_ -2 `"Refusal"', modify
cap la de ws007_ -1 `"Don't know"', modify
cap la de ws007_ 1 `"Suitable space available"', modify
cap la de ws007_ 2 `"No suitable space"', modify
cap la de ws010_ -2 `"Refusal"', modify
cap la de ws010_ -1 `"Don't know"', modify
cap la de ws010_ 1 `"Completed successfully"', modify
cap la de ws010_ 2 `"Attempted but unable to complete"', modify
cap la de ws010_ 3 `"Stopped by the interviewer because of safety reasons"',modify
cap la de ws010_ 4 `"Not attempted, respondent felt it would"', modify
cap la de ws010_ 5 `"Participant unable to understand instruction"', modify
cap la de ws010_ 6 `"Respondent refused"', modify
cap la de dkrf -2 `"Refusal"', modify
cap la de dkrf -1 `"Don't know"', modify
cap la de ws015_ -2 `"Refusal"', modify
cap la de ws015_ -1 `"Don't know"', modify
cap la de ws015_ 1 `"Linoleum/tile/wood"', modify
cap la de ws015_ 2 `"Low-pile carpet"', modify
cap la de ws015_ 3 `"Thick-pile carpet"', modify
cap la de ws015_ 4 `"Woncrete"', modify
cap la de ws015_ 5 `"Not sure"', modify
cap la de ws015_ 97 `"Other"', modify
cap la de ws017_ -2 `"Refusal"', modify
cap la de ws017_ -1 `"Don't know"', modify
cap la de ws017_ 1 `"None"', modify
cap la de ws017_ 2 `"Walking stick or cane"', modify
cap la de ws017_ 3 `"Elbow crutches"', modify
cap la de ws017_ 4 `"Walking frame"', modify
cap la de ws017_ 97 `"Other"', modify
...
cap recast byte ws001_
cap recast byte ws002_
cap recast byte ws003_
cap recast byte ws004_
cap recast byte ws005_
cap recast byte ws007_
cap recast byte ws010_
cap recast double ws011_
cap recast byte ws012_
cap recast double ws013_
cap recast byte ws014_
cap recast byte ws015_
cap recast byte ws017_
...
cap form ws001_ %60.0g
cap form ws002_ %34.0g
cap form ws003_ %39.0g
cap form ws004_ %10.0g
cap form ws005_ %10.0g
cap form ws007_ %24.0g
cap form ws010_ %58.0g
cap form ws011_ %10.0g
cap form ws012_ %58.0g
cap form ws013_ %10.0g
cap form ws014_ %10.0g
cap form ws015_ %29.0g
cap form ws017_ %21.0g
cap la val country country
cap la val language language
cap la val ws001_ ws001_
cap la val ws002_ ws002_
cap la val ws003_ ws003_
cap la val ws004_ yesno
cap la val ws005_ yesno
cap la val ws007_ ws007_
cap la val ws010_ ws010_
cap la val ws011_ dkrf
cap la val ws012_ ws010_
cap la val ws013_ dkrf
cap la val ws014_ yesno
cap la val ws015_ ws015_
cap la val ws017_ ws017_
...
cap la var ws001_ `"Record respondent status"'
cap la var ws002_ `"Able to walk alone (using aid)"'
cap la var ws003_ `"Is it safe to carry out the test"'
cap la var ws004_ `"Respondent willing to do walking test"'
cap la var ws005_ `"Does respondent feel safe to continue"'
cap la var ws007_ `"Check available space for test"'
cap la var ws010_ `"Result of first trial"'
cap la var ws011_ `"Time of first walking speed test"'
cap la var ws012_ `"Result of second trial"'
cap la var ws013_ `"Time of second walking speed test"'
cap la var ws014_ `"Did the respondent have comment on pain"'
cap la var ws015_ `"Record type of floor surface"'
cap la var ws017_ `"Type of aid used during test"'
