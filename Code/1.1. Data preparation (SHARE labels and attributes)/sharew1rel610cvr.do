...
cap la de cvresp -2 `"Refusal"', modify
cap la de cvresp -1 `"Don't know"', modify
cap la de cvresp 0 `"No"', modify
cap la de cvresp 1 `"Yes"', modify
...
cap la de finsep -9 `"Not applicable"', modify
cap la de finsep -2 `"Refusal"', modify
cap la de finsep -1 `"Don't know"', modify
cap la de finsep 1 `"Separately"', modify
cap la de finsep 5 `"Together"', modify
...
cap recast byte waveid
cap recast byte waveid_hh
...
cap form cvresp %10.0g
cap form gender %10.0f
cap form mobirth %10.0f
cap form yrbirth %10.0f
cap form age2004 %14.0g
cap form age_int %14.0g
cap form mobirthp %14.0g
cap form yrbirthp %14.0g
cap form agep2004 %14.0g
cap form partnerinhh %14.0g
cap form relrpers %30.0f
cap form hhsize %9.0g
cap form fam_resp %21.0g
cap form fin_resp %24.0g
cap form finsep %14.0g
...
cap la var age2004 `"Age in 2004"'
...
cap la var agep2004 `"Age of partner in 2004"'
...
cap la var finsep `"Finances totally separate"'
cap la var hou_resp `"Household respondent"'
cap la var ILgroup `"Population group (Israel only)"'
cap la var interview `"Interview done in wave 1"'
